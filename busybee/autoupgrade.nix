...

{
  ...
  systemd.user.services.update-user-containers = {
      ...
      serviceConfig = {
          Type = "oneshot";
          TimeoutStartSec = 900;
          ExecStart = "${pkgs.systemd}/bin/systemctl --user restart crate jellyfin homepage ara hedgedoc parallel monitoring gitea ittools shopping atuin-syncer authentik-svc mealie-app searxng fileshare linkwarden-app kube-composer-app";
